...
def afk(bot: Bot, update: Update):
    ...
    send_message(update.effective_message, tl(update.effective_message, "{} Dia Sekarang Sudah Meninggoy Dengan Tenang! 😭🤧").format(update.effective_user.first_name))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        send_message(update.effective_message, tl(update.effective_message, "{} Ehh Dia Hidup Lagi Anjirr, Mati Lagi Ke Lu :v 😂🤧").format(update.effective_user.first_name))
