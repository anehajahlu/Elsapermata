...
def afk(bot: Bot, update: Update):
    ...
    send_message(update.effective_message, tl(update.effective_message, "{} Ehh Dia Sekarang Sudah Meninggoy! 😭🤧").format(update.effective_user.first_name))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        send_message(update.effective_message, tl(update.effective_message, "{} Astaga Kenapa Kamu Hidup Lagi Sii?! 😂🤧").format(update.effective_user.first_name))
